...
public class Console {
    ...
    public Console() throws IOException {
        ...
        registeryMobilePhone.loadRegistry();
        mainView.startPhone();
    ...
    private void exit() {
        registeryMobilePhone.saveRegistry();
...
//        System.out.println(contact.getName());
        ...
        System.out.println(" has been modified to "+
                this.registeryMobilePhone.getContacts().get(t).getName()+
